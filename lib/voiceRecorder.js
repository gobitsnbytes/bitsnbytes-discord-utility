...
async function startRecording(voiceChannel, meetingId, client) {
	...
	const session = {
		...
		speakingTimeline: [], // Track voice activity segments: { userId, displayName, startTime, endTime }
		speakingStates: new Map(), // Track who is currently speaking: userId -> startTime (ms)
	};
	...
	// Auto-subscribe and track speaking start
